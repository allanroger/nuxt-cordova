...
exports.defineAutoTests = function () {
  ...
  const isWindowsStore = (cordova.platformId == 'windows8') || (cordova.platformId == 'windows' && !WinJS.Utilities.isPhone);
  ...
  const skipAndroid = cordova.platformId == 'android' && (device.isVirtual || majorDeviceVersion >= 6);
